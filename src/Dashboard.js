...
const steps = [
  {
    ...
    description: ({ totalValue, totalStocks, averagePrice }) => (
      <>
      ...
      <div>
        ...
        <div className="help-container">
                ...
                <div key={index} className="step">
                  ...
                  <div>
                    {typeof step.description === "function"
                      ? step.description({ totalValue, totalStocks, averagePrice })
                      : step.description}
                  </div>
                  {step.image && (
                    <img
          ...
          <section className="faq">
            <h1 className="help-header">Frequently Asked Questions (FAQ'S)</h1>
